...
def criando_janela():
    sg.theme_background_color('#303030')
    linha = [
        # Criando uma linha inicial que vai ser uma tarefa individual
        [sg.Checkbox('', background_color='#303030', text_color='#FFA500'),
    ...
    layout = [
        ...
        [sg.Frame('Tarefas', layout= linha, background_color='#303030',
    ...
    return sg.Window('Developed by Airton Fabre', layout=layout,
                     finalize=True, background_color='#303030', location=(400, 100))
